...
output_file_mutated <- file.path(base_dir, "top_five_binding_prob_mutated_predicted.csv")
...
top_five_binding_normal <- filtered_binding_data %>%
  ...
  select(miRNA_MIMAT_ID_Species, database, target_ensembl, target_symbol, seed_sequence_normal, seed_sequence_mutated,
         pos.mut, binding_prob_normal_8mer, binding_prob_normal_7mer_m8, binding_prob_normal_7mer_A1, binding_prob_normal_6mer,
...
top_five_binding_mutated <- filtered_binding_data %>%
  ...
  ungroup() %>%  # Ungroup the data
  select(miRNA_MIMAT_ID_Species, database, target_ensembl, target_symbol, seed_sequence_normal, seed_sequence_mutated,
         pos.mut, binding_prob_mutated_8mer, binding_prob_mutated_7mer_m8, binding_prob_mutated_7mer_A1, binding_prob_mutated_6mer,
