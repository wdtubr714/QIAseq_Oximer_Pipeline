...
mirna_targets <- read.csv(file.path(base_dir, "mirna_targets_predicted.csv"))
...
output_file <- file.path(base_dir, "mirna_binding_probabilities_biostrings_predicted.csv")
