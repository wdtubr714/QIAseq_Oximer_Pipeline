...
final_df <- top_targets %>%
  select(mature_mirna_id, database, target_ensembl, target_symbol, Sequence,
...
output_file <- file.path(base_dir, "mirna_binding_probabilities_disruption_predicted_top_targets.csv")
